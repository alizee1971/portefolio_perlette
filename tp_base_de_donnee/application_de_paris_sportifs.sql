...
--
-- Base de données : `application_de_paris_sportifs`
--
...
(200, 'PSG', 'OM', '2025-11-17 14:46:48', 106),
(206, 'Nadal', 'Federer', '2025-11-17 14:47:55', 109),
(208, 'Lackers', 'Bulls', '2025-11-17 14:46:48', 108);
...
(100, 'Dupont', 'Marc', 'Dupont.Marc@gmail.com'),
(102, 'Lopez', 'Sara', 'Lopez.Sara@gmail.com'),
(103, 'Idrissi', 'Karim', 'Idrissi.Karim@gmail.com');
...
--
ALTER TABLE `matchs`
  MODIFY `id_match` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=209;
...
--
ALTER TABLE `sport`
  MODIFY `id_sport` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=110;
